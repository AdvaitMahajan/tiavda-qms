...
export const team_members = pgTable('team_members', {
  ...
  is_geologist: boolean('is_geologist').notNull().default(false),
  is_supervisor: boolean('is_supervisor').notNull().default(false),
  is_active: boolean('is_active').notNull().default(true),
...
export const site_visits = pgTable('site_visits', {
  ...
  geologist_member_id: uuid('geologist_member_id'),
  supervisor_member_id: uuid('supervisor_member_id'),
