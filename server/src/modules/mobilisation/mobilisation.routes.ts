...
const updateSchema = z.object({
  ...
  team_lead_status: z.enum(['pending', 'accepted', 'reschedule_requested']).optional(),
  team_lead_responded_at: z.string().nullable().optional(),
  team_lead_proposed_date: z.string().nullable().optional(),
  team_lead_note: z.string().nullable().optional(),
