...
--
-- Text follows that document, with two spellings corrected at the client's
-- request ("accomodation" -> "accommodation", "quantites" -> "quantities").
-- The template numbers two notes "3"; they are renumbered sequentially here
-- because the PDF numbers the list automatically.
--
...
CROSS JOIN (VALUES
  ...
  ('quotation_note_2',  'Clean place to make hutment or room for labour''s accommodation (at site) should be arranged by client.'),
  ...
  ('quotation_note_10', 'The quantities presented herewith are assumed on the basis of working in the general project area. Actual quantities may vary and the final billing shall be done on the basis of actual quantities only.'),
